<?php
/**
 * Plugin Name: wd_s Theme Generator
 * Description: Generates themes based on the wd_s theme.
 */
class WDS_Wdunderscores_Generator {
	 ...
	 */
	function wds_wdunderscores_print_form() {
		?>
			...
			<form method="POST">
				...
				<section class="generator-form-inputs">
					<section class="generator-form-primary">
						...
						<input type="text" id="underscoresme-name" name="wds_wdunderscores_name" placeholder="Theme/Client Name" />
						<p class="description">Acme Inc.</p>

						<label for="underscoresme-theme-uri">Theme/Client URL</label>
						<input type="text" id="underscoresme-theme-uri" name="wds_wdunderscores_theme_uri" placeholder="Theme/Client URL" />
						<p class="description">https://acmeinc.com</p>

						<label for="underscoresme-description">Theme Description</label>
						<input type="text" id="underscoresme-description" name="wds_wdunderscores_description" placeholder="Theme Description" />
						...
						<input type="text" id="underscoresme-functions" name="wds_wdunderscores_functions" placeholder="Theme Functions Prefix (wds_client)" />
						<p class="description">Functions prefix. Use underscores: wds_acme</p>

						<label for="underscoresme-slug">Theme Text Domain</label>
						<input type="text" id="underscoresme-slug" name="wds_wdunderscores_slug" placeholder="Theme Text Domain (wds-client)" />
						<p class="description">Text domain prefix. Use hyphens: wds-acme</p>

						<label for="underscoresme-author">Theme Author</label>
						<input type="text" id="underscoresme-author" name="wds_wdunderscores_author" placeholder="Theme Author" />
						<p class="description">WebDevStudios</p>

						<label for="underscoresme-author-uri">Theme Author URL</label>
						<input type="text" id="underscoresme-author-uri" name="wds_wdunderscores_author_uri" placeholder="Theme Author URL" />
						<p class="description">https://webdevstudios.com</p>

						<label for="underscoresme-author-email">Theme Author Email</label>
						<input type="text" id="underscoresme-author-email" name="wds_wdunderscores_author_email" placeholder="Theme Author Email" />
						<p class="description">wds@webdevstudios.com</p>

						<label for="underscoresme-dev-uri">Theme Development URL</label>
						<input type="text" id="underscoresme-dev-uri" name="wds_wdunderscores_dev_uri" placeholder="Theme Development URL" />
...
function wds_wdunderscores_generator() {
	return new WDS_Wdunderscores_Generator;
}