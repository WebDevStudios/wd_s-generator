			...
			<main id="main" class="site-main" role="main">
				<div class="wrap">
					...
					<section class="content-section generator" role="main">
						<h2>Create a wd_s based theme</h2>
					...
					<section class="content-section install">
						...
						<ol>
							...
							<li>Download, extract, and place your new theme files into wp-content/themes</li>
					...
					<section class="content-section about">
						<h2>About</h2>
						<a href="https://github.com/WebDevStudios/wd_s">wd_s</a> is a fork of <a href="https://github.com/Automattic/_s">Automattic's _s</a>. It's used as the starter theme at <a href="https://webdevstudios.com">WebDevStudios</a>, a leading WordPress development agency.
					</section><!-- .contribute -->
